...
const home = () => {
    return <><div className="intro-card">
        ...
        <p className="introduction">Welcome to the latest greatest (unofficial) fan app for Rick and Morty.
        Here, you'll be able to see a list of all Rick and Morty episodes, characters
        and locations.
